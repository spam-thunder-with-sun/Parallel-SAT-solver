...
do
    srun mathsat -input=dimacs $path2$filename -stats  -verbosity=2
done
...
do
    srun mathsat -input=dimacs $path1$filename -stats  -verbosity=2
done

#for filename in ${filenames3[@]};
#do
#    srun mathsat -input=dimacs $path3$filename -stats  -verbosity=2
#done